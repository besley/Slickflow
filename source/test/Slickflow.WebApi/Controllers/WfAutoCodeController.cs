...
namespace Slickflow.WebApi.Controllers
{
    ...
    //GetNextSteps
    //{"AppName": "SamplePrice", "AppInstanceId": 915, "UserId": "10", "UserName": "Long", "ProcessId": "5d6a7d6f-da2-482d-8303b3b9f59a6a", "NextActivity Performers": {"39c71004-d822-4c15-9ff2-94ca1068d745": [{"UserId": "10", "UserName": "Long"}]}, "Flowstatus": "Start"}
            ...
            try
            {
                ...
                var wfResult = wfService.CreateRunner(runner.UserId, runner.UserName)
                         ...
                         .Subscribe(EventFireTypeEnum.OnActivityExecuting, (delegateContext, delegateService) => {
                             ...
                             {
                                 delegateService.SaveVariable(ProcessVariableScopeEnum.Process, "name", "book-task1");
                                 delegateService.SaveVariable(ProcessVariableScopeEnum.Process, "amount", "50");
                             }
                             return true;
                         })
                         .Run();
