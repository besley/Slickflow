...
namespace Slickflow.Engine.Utility
{
    ...
    public class XMLHelper
    {
        ...
        public static XmlNode GetXmlNodeByXpath(XmlDocument xmlDoc, string xpath, XmlNamespaceManager nsmgr)
        {
            try
            {
                XmlNode xmlNode = xmlDoc.DocumentElement.SelectSingleNode(xpath, nsmgr);
                return xmlNode;
            }
        ...
        public static XmlNodeList GetXmlNodeListByXpath(XmlDocument xmlDoc, string xpath, XmlNamespaceManager nsmgr = null)
        {
            try
            {
                var nodeList = xmlDoc.DocumentElement.SelectNodes(xpath, nsmgr);
                return nodeList;
            }
            catch(System.Exception ex)
            {
