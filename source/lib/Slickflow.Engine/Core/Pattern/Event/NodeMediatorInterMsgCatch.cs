...
namespace Slickflow.Engine.Core.Pattern.Event
{
    ...
    internal class NodeMediatorInterMsgCatch : NodeMediator, ICompleteAutomaticlly
    {
        ...
        public NodeAutoExecutedResult CompleteAutomaticlly(ProcessInstanceEntity processInstance,
            ...
            IDbSession session)
        {
            var nextActivityInstance = base.CreateActivityInstanceObject(toActivity, processInstance, runner);
            ...
            base.LinkContext.ToActivityInstance = nextActivityInstance;
            ...
            base.CreateActivityTaskTransitionInstance(toActivity,
                ...
                base.ActivityForwardContext.ActivityResource,
                session);
