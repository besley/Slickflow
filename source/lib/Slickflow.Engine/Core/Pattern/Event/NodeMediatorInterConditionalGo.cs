...
namespace Slickflow.Engine.Core.Pattern.Event
{
    ...
    internal class NodeMediatorInterConditionalGo : NodeMediator
    {
        ...
        internal override void ExecuteWorkItem()
        {
            ...
            {
                //检查条件节点运行条件
                CheckBeingExecutedInfo(this.Session);
        ...
        private void CheckBeingExecutedInfo(IDbSession session)
        {
            ...
            var isConditionPassed = pvm.ValidateProcessVariable(session.Connection, base.LinkContext.FromActivityInstance.ProcessInstanceID, 
