...
namespace Slickflow.Engine.Core.Pattern.Gateway
{
    ...
    /// OrSplit 节点处理类
    /// </summary>
    internal class NodeMediatorOrSplit : NodeMediatorGateway, ICompleteGatewayAutomaticlly
    {
        internal NodeMediatorOrSplit(Activity activity, IProcessModel processModel, IDbSession session)
