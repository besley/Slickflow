...
namespace Slickflow.Engine.Core.SendBack
{
    ...
    internal class NodeSendBackMISReady : NodeSendBack
    {
        ...
        internal override void Execute()
        {
            ...
            var runningMainNode = base.ActivityInstanceManager.GetById(runningNode.MainActivityInstanceId.Value);
            ...
            {
                base.ActivityInstanceManager.Rerun(previousActivityInstance.MainActivityInstanceId.Value,
                    base.Session, runner);
            }
        }
