...
{
    /// <summary>
    /// Workflow Service - Chain Interface
    /// 工作流服务 - 链式接口
    /// </summary>
    public partial class WorkflowService : IWorkflowService
    {
        #region Property
        /// <summary>
        /// Workflow App Runner (used for chain interface)
        /// 工作流应用运行器（用于链式接口）
        /// </summary>
        ...
        /// 使用流程定义
        /// </summary>
        public IWorkflowService UseProcess(string processId, string version = null)
        {
        ...
        /// <summary>
        /// Next activity (Internal method for testing)
        ...
        /// 活动事件订阅
        /// </summary>
        public IWorkflowService Subscribe(EventFireTypeEnum eventType, Func<EventContext, IEventService, Boolean> func)
        {
            _wfAppRunner.EventSubscriptionList.Add(
                new KeyValuePair<EventFireTypeEnum, Func<EventContext, IEventService, bool>>(eventType, func)
            );
            return this;
        }
