...
namespace DapperExtensions.Mapper
{
    ...
    public class PropertyMap : IPropertyMap
    {
        public PropertyMap(PropertyInfo propertyInfo)
        {
            ...
            //get custom attribute column value to map column in database
            dynamic columnAttribute = propertyInfo.GetCustomAttributes(false).FirstOrDefault(attr => attr.GetType().Name == "Column") as dynamic;
            ColumnName = columnAttribute != null ? columnAttribute.ColumnName : PropertyInfo.Name;
        }
