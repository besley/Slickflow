...
{
    public partial class MySQLFirstMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedToUserIDs = table.Column<string>(type: "varchar(1000)", maxLength: 1000, nullable: true),
                    AssignedToUserNames = table.Column<string>(type: "varchar(2000)", maxLength: 2000, nullable: true),
                    ...
                    EndedDateTime = table.Column<DateTime>(type: "datetime", nullable: true),
                    ...
                    LastUpdatedByUserName = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InnerStackTrace = table.Column<string>(type: "varchar(4000)", maxLength: 4000, nullable: true),
                    Message = table.Column<string>(type: "varchar(500)", maxLength: 500, nullable: true),
                    Priority = table.Column<int>(nullable: false),
                    RequestData = table.Column<string>(type: "varchar(2000)", maxLength: 2000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastUpdatedDateTime = table.Column<DateTime>(type: "datetime", nullable: true),
                    PageUrl = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: true),
                    ProcessGUID = table.Column<string>(type: "varchar(100)", maxLength: 100, nullable: false),
                    ...
                    Version = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: false, defaultValue: "1"),
                    XmlContent = table.Column<string>(type: "text", nullable: true),
                    XmlFileName = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true),
                    XmlFilePath = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastUpdatedByUserID = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: true),
                    LastUpdatedByUserName = table.Column<string>(type: "varchar(50)", nullable: true),
                    LastUpdatedDateTime = table.Column<DateTime>(type: "datetime", nullable: true),
                    OverdueDateTime = table.Column<DateTime>(type: "datetime", nullable: true),
                    OverdueTreatedDateTime = table.Column<DateTime>(type: "datetime", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedToUserName = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false),
                    CreatedByUserID = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false),
                    CreatedByUserName = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false),
                    CreatedDateTime = table.Column<DateTime>(type: "datetime", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.ComputedColumn),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FromActivityName = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false),
                    ...
                    ToActivityName = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false),
