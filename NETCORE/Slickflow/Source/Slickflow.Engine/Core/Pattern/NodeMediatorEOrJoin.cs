...
namespace Slickflow.Engine.Core.Pattern
{
    ...
    /// OrJoin 节点处理类
    /// </summary>
    internal class NodeMediatorEOrJoin : NodeMediatorGateway, ICompleteAutomaticlly
    {
        internal NodeMediatorEOrJoin(ActivityEntity activity, IProcessModel processModel, IDbSession session)
