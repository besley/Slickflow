...
namespace Slickflow.Engine.Core.Pattern
{
    ...
    /// 多实例与分支节点处理类
    /// </summary>
    internal class NodeMediatorAndSplitMI : NodeMediatorGateway, ICompleteAutomaticlly
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        ...
        internal NodeMediatorAndSplitMI(ActivityEntity activity, IProcessModel processModel, IDbSession session)
