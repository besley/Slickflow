...
namespace Slickflow.Engine.Core.Pattern
{
    ...
    /// AndJoin 节点处理类
    /// </summary>
    internal class NodeMediatorAndJoinMI : NodeMediatorGateway, ICompleteAutomaticlly
    {
        ...
        internal int GetTokensRequired(string appInstanceID, int processInstanceID, ActivityEntity joinNode)
        {
