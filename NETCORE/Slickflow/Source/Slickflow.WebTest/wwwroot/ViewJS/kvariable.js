...
var kvariable = (function () {
        ...
        jshelper.ajaxPost('api/Wf2Xml/GetProcessVariableList', JSON.stringify(query), function (result) {
            if (result.Status === 1) {
                ...
                $.msgBox({
                    ...
                    content: kresource.getItem("processvariablelistloaderrormsg") + result.Message,
                    type: "error"
                });
            }
        });
            ...
            jshelper.ajaxPost('api/Wf2Xml/InsertProcessVariable',
                ...
                function (result) {
                    if (result.Status == 1) {
                        $.msgBox({
                            title: "Process / Variable",
                            content: kresource.getItem('processvariablesaveokmsg'),
                            type: "info"
                        });
                        ...
                        $.msgBox({
                            title: "Process / Variable",
                            content: kresource.getItem('processvariablesaveerrormsg') + result.Message,
                            type: "error",
                            buttons: [{ value: "Ok" }],
                        });
                    }
    ...
    kvariable.delete = function () {
        $.msgBox({
            title: "Are You Sure",
            content: kresource.getItem('processvariabledeletemsg'),
            type: "confirm",
                        ...
                        jshelper.ajaxPost('api/Wf2Xml/DeleteProcessVariable',
                            ...
                            function (result) {
                                if (result.Status == 1) {
                                    $.msgBox({
                                        title: "Process / Variable",
                                        content: kresource.getItem('processvariabledeleteokmsg'),
                                        type: "info"
                                    });
                                    kvariable.getVariableList();
                                } else {
                                    $.msgBox({
                                        title: "Process / Variable",
                                        content: kresource.getItem('processvariabledeleteerrormsg') + result.Message,
                                        type: "error",
                                        buttons: [{ value: "Ok" }],
                                    });
                                }
