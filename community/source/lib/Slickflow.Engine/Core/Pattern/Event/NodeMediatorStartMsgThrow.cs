...
namespace Slickflow.Engine.Core.Pattern.Event
{
    ...
    /// 开始节点执行器
    /// </summary>
    internal class NodeMediatorStartMsgThrow : NodeMediator
    {
        internal NodeMediatorStartMsgThrow(ActivityForwardContext forwardContext, IDbSession session)
            ...
            IDbSession session)
        {
            ...
            msgDelegateService.PublishMessage(processInstance, base.LinkContext.FromActivity, fromActivityInstance);
