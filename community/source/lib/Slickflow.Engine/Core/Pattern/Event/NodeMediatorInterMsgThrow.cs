...
using Slickflow.Engine.Essential.Message;
...
namespace Slickflow.Engine.Core.Pattern.Event
{
    ...
    internal class NodeMediatorInterMsgThrow : NodeMediator, ICompleteAutomaticlly
    {
        ...
        public NodeAutoExecutedResult CompleteAutomaticlly(ProcessInstanceEntity processInstance,
            ...
            IDbSession session)
        {
            var messageActivityInstance = base.CreateActivityInstanceObject(toActivity, processInstance, runner);
            base.LinkContext.ToActivity = toActivity;
            base.LinkContext.ToActivityInstance = messageActivityInstance;
            ...
            msgDelegateService.PublishMessage(processInstance, base.LinkContext.ToActivity, messageActivityInstance);
