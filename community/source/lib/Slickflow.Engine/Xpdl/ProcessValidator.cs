...
namespace Slickflow.Engine.Xpdl
{
    ...
    internal class ProcessValidator
    {
        ...
        internal static ProcessValidateResult Validate(ProcessValidate entity)
        {
        ...
        internal static IList<Activity> TranverseTransitonList(IList<Activity> activityList,
