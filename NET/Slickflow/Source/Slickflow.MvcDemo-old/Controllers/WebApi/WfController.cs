...
namespace SfDemo.WebApi.Controllers
{
    ...
    /// 示例代码，请勿直接作为生产项目代码使用。
    /// </summary>
    public class WfController : ApiControllerBase
    {
        /// <summary>
        /// 读取XML文件
        /// </summary>
        ...
        /// <returns></returns>
        [HttpPost]
        public ResponseResult<List<Role>> QueryProcessRoles(ProcessQuery query)
        {
        ...
        /// <returns></returns>
        [HttpPost]
        public ResponseResult<List<Role>> QueryProcessRoleUserList(ProcessQuery query)
        { 
            var result = ResponseResult<List<Role>>.Default();
                        try
            {
