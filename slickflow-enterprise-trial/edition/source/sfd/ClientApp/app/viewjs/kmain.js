...
const kmain = (function () {
    ...
    var initializeGlobalVariables = function () {
        ...
        kmain.mxImageUrl['sequence'] = 'slickflow-multiple-sequence-demo.gif';
    ...
    kmain.createFromTemplate = function () {
        kmain.mxSelectedProcessEntity = null;
        processlist.pselectedProcessEntity = null;

        var BootstrapDialog = require('bootstrap5-dialog');
        kmain.templateDialog = BootstrapDialog.show({
            message: $('<div id="createFromTemplate"></div>'),
            title: kresource.getItem("createfromtemplate"),
            onshown: function () {
                $("#createFromTemplate").load('pages/process/template.html')
            },
            draggable: true
        });
    }
    ...
    kmain.openDemo = function (pattern) {
        var win = window.open("images/demo/" + kmain.mxImageUrl[pattern], '_blank');
        win.focus();
    }
