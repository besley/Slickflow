...
#else
        public CommandDefinition(IDbConnection cnn, string commandText, object parameters = null, IDbTransaction transaction = null, int? commandTimeout = null,
...
#endif
        {
            this.commandText = DefaultParameterCharacter.ReplacePrefixParameter(cnn, commandText);
...
this IDbConnection cnn, string sql, object param = null, IDbTransaction transaction = null, int? commandTimeout = null, CommandType? commandType = null
        ...
        {
            var command = new CommandDefinition(cnn, sql, (object)param, transaction, commandTimeout, commandType, CommandFlags.Buffered);
