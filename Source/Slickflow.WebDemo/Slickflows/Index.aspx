<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Slickflow.WebDemoV2._0.Slickflows.Index" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>Slickflow.WebDemo V2.0</title>
        ...
        <div class="main-sidebar">
            <div id="sidebar-nav" class="sidebar-nav">
                <div class="list-box">
                    ...
                    <div class="list-group" name="Slickflow.WebDemoV2.0">
                        <h2>流程管理<i></i></h2>
                        <ul>
                            <li>
                                <a navid="plugin_link" href="FlowList.aspx" target="mainframe" class="item">
                                    <span>流程列表</span>
                                </a>
                            </li>
                        </ul>
                        ...
                        <ul>
                            <li>
                                <a navid="plugin_link" href="Tool.aspx" target="mainframe" class="item">
                                    <span>工具箱</span>
                                </a>
                            </li>
                        </ul>
