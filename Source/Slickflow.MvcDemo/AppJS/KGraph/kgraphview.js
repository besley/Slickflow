...
(function () {
    ...
    kgraph.GraphView = function (graphData) {
        ...
        this.drawSingleNode = function (target) {
            var snode = {
            ...
            if (target.type == "StartNode")
                snode.name = "开始"
            else if (target.type == "EndNode")
                snode.name = "结束"
            else if (target.type == "GatewayNode")
                snode.name = "Gateway"
            else if (target.type == "SubProcessNode")
                snode.name = "子流程";
            else
                snode.name = "新节点"
    ...
    kgraph.Node = function (snode) {
        ...
        this.render = function () {
            ...
            else if (this.type() === "SubProcessNode") {
            ...
            jsPlumb.draggable(nodeId, {
                stop: function (event, ui) {
                    ...
                    snode.left = Math.round(left);
                    snode.top = Math.round(top);
                }
            });
